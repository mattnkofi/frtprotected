                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button v-if="newFile" @click="clearFile" type="button"
                    ...
                    <!-- <div>
                        ...
                        <div class="flex items-center gap-3">
                            <input type="file" accept="image/*" @change="handleThumbnailSelect" ref="thumbnailInput"
                                class="flex-1 text-sm text-gray-600 dark:text-gray-400" />
                            <button v-if="newThumbnail" @click="clearThumbnail" type="button"
                                class="px-3 py-1 text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded">
                                Clear
                            </button>
                        </div>
                    ...
                    <div>
                        ...
                        <div v-if="module.thumbnail_url && !newThumbnail" class="mb-3">
                            <p class="text-xs text-gray-500 mb-1">Current Thumbnail:</p>
                            <img :src="module.thumbnail_url" alt="Current thumbnail"
                                class="w-32 h-20 object-cover rounded border dark:border-abyss-600" />
                        </div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                            Max 5MB - Images only. Leave empty to keep the current thumbnail.
                        </p>
                    </div>
