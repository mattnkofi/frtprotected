...
<template>
    <div 
        class="module-card bg-white dark:bg-abyss-800 rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer group"
    ...
    >
        ...
        <div class="relative h-48 bg-gray-200 dark:bg-abyss-700 overflow-hidden">
            ...
            <div class="absolute bottom-2 left-2">
                <span class="bg-blue-600 dark:bg-blue-700 text-white px-3 py-1 rounded-full text-xs uppercase font-semibold shadow-lg">
        ...
        <div class="p-4">
            ...
            <!-- Meta info -->
            <div class="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400 mb-3 pb-3 border-b dark:border-abyss-700">
