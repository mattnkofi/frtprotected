    ...
    <div class="document-viewer">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <button 
                    v-if="canPreview && isPDF"
                    @click="viewMode = viewMode === 'preview' ? 'download' : 'preview'"
                ...
                >
                    <svg v-if="viewMode === 'preview'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="border dark:border-abyss-600 rounded-lg overflow-hidden bg-gray-50 dark:bg-abyss-900">
            ...
            <div v-else class="text-center py-20">
                <div class="p-6 bg-blue-50 dark:bg-blue-900/20 border-2 border-dashed border-blue-300 dark:border-blue-700 rounded-lg inline-block">
                    <svg class="w-20 h-20 mx-auto text-blue-600 dark:text-blue-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                    </svg>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-4">
                        {{ isWord ? 'Word documents must be downloaded to view' : 'Preview not available for this file type' }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="mt-4 text-sm text-gray-500 dark:text-gray-400">
            <p v-if="!canPreview || viewMode === 'download'">
                💡 Tip: Download the file to your device for the best viewing experience
            </p>
            <p v-else-if="isPDF">
                💡 Tip: You can zoom, navigate pages, and use other PDF controls in the viewer above
            </p>
        </div>
    </div>
</template>
